...
// ref: https://raw.githubusercontent.com/ZaynChen/webkit-greeter-api/refs/heads/main/types.d.ts
...
declare global {
  function send_request<T extends GreeterRequestTarget>(request: {
    target: T;
